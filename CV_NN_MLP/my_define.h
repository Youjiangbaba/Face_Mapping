...
#define eyes_xml   "eyes.xml"
#define eyes_train "DATA/eyes.txt" //"../FaceDeal_Demo1.22/train_dataold/eyes.txt"
#define eyes_test  "DATA/testdata.txt"
#define eyes_result  "resultfile.txt"
